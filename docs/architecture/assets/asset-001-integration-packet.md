...
The owner reconfirmed this boundary on 2026-09-01 and explicitly approved typed vehicle powertrain evidence (`GASOLINE`, `DIESEL`, `ELECTRIC`, `HYBRID`, `OTHER`, `UNKNOWN`). Powertrain is never inferred from make/model. Odometer evidence is append-only and regressions fail closed rather than replacing accepted readings.
...
- Current-head reconciliation base: `e808b70e52d776222796b4a69c14f7d7e9260384`.
