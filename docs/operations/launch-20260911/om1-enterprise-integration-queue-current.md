...
Snapshot: 2026-09-14 19:02 America/New_York

## Authority and deployed state

- Protected authority: `858b59cdadbedd9bb6a248debea8b40e3a3941af`
- Protected tip: PR #278, pay-period Payroll policy authority
- Deployed Preview: `858b59cdadbedd9bb6a248debea8b40e3a3941af`
...
- Acceptance state: pending. Preview initially remained at `b296cc6b...` after
  ...
  transient incidents in acceptance evidence. Required #261-#278 evidence and
...
not later #261-#278. That bounded run passed PostgreSQL zero-to-head, 20 affected
...
|---|---|---|---|---:|---|---|
| OM2-C persona contract and acceptance harness | `work/om2c-launch-20260911-e2e-acceptance-1` | `1fb0481a043caaca749ae5dd49dc6cdf6d994061` | None; prior #212 is merged | 14/46 | `3129ade3aaa1bf9ce07cba646c266c88aa26e226` | Stale but reconcilable; merge-clean; protected/schema bindings must advance; acceptance execution blocked on missing platform service principal |
| SOURCE.4 artifact recovery | `work/migration-source4-accepted-artifact-recovery-1` | `a3cad3d389b9ed69300939d15c19e2d7b08da063` | None | 19/1 | `ea688fdb08aec9261ca1c17ce611642d356ab27f` | Stale but reconcilable; merge-clean; documentation-only |
| HCP historical safe-tranche builder | `work/hcp-historical-safe-tranche-1` | `b32f99ff80f447bf8140b73380d19191ccb8db59` | None | 29/1 | `521be005d48e21dafcb02ca2ffa05098d30936d5` | Stale but reconcilable; merge-clean; metadata edit required |
| SOURCE.4 UPDATE cohort authority | `work/hcp-update-cohort-authority-1` | `d53e5d36422218bd715f07d8099e09865167e0f1` | None | 13/1 | `e86cb8b661081ec431900b941c6b1d538e60076c` | Stale but reconcilable; merge-clean, but blocked: unsafe overwrite/symlink handling, incomplete authority verification, and no command/generator integration tests |
| ECO reconciliation | `work/eco-migration-reconciliation-integration-watch-1` | `1c0e7b20db62b6a342548f2842ea1a3a45965386` | None | 21/13 | `9205596ec951899e2919c675dc51a3ae535760ca` | Blocked on schema reconciliation; duplicate protected revision ID; rebase and assign a new revision downstream of `h8j0l2n4p6r8` |
| Payroll/QBO read UI | `work/om2b-payroll-accounting-continuation-1` | `724398348b566f655d2bc7127c20beeb6be52d6c` | #215 open/CLEAN | 40/1 | `980923c2dcdd312755d19b49762708671e11aeb4` | Stale but reconcilable; merge-clean after #278 despite shared Payroll route/tests; blocked behind projection-authorization repair, PR refresh, and combined rerun |
| Mobile Apple release packet | `work/mobile-apple-owner-release-packet-1` | `0183eaec3e2825a79b683e9e684a761243c86ea7` | None | 26/15 | `f4b43c0a049a821eddd6cc74c003a7b5b7e124fb` | Stale but reconcilable; merge-clean; blocked on visible-error/concurrency repair successor and two manifest edits |
...
`cc808f3e1eee1d04a7649d945cf8d9c1b546e644`; they change 29 files and pass
`git diff --check`. Including blocked Mobile remains mechanically clean at tree
`48dc1da38c5a2d420d0886bbf7fb74c13de773df` across 51 files. Recompute all
...
8. Treat #277/#278 as protected but operationally blocked; repair the projection
   authorization mismatch, then reconcile PR #215 over the shared Payroll
...
```mermaid
flowchart LR
    A[Protected 858b59cd through pay-period policy authority] -->|reconcile| R[SOURCE.4 recovery]
...
|---|---|---|
| Acceptance tooling | Reconcile `1fb0481a...` to `858b59cd...`, update schema/release bindings, then open a fresh PR. Route the declared service-principal/activation/session/token-writer gaps to Enterprise/platform before persona issuance | Contract tests fail, protected SHA moves, platform primitive remains missing at execution time, persona permissions/digests differ, or secret material appears in arguments/evidence |
| Current deployed acceptance | Preserve consecutive exact-`858b59cd...` healthy responses at 19:00-19:02, the #277 rollout HTTP 502 at 18:48, old-`80e665a6...` recovery through 18:59, and all earlier evidence; attach or rerun missing #261-#278 qualification; keep protected Migration commands/verifier, #273-#276 operator action, and #277/#278 office mutation disabled | Deployed SHA differs, focused test, zero-to-head migration, exactly-one-head/drift check fails, required evidence cannot be produced, defective tooling is exercised, or health/dependency state regresses |
...
| Wave B | Repair #278's projection authorization mismatch; then accept #277/#278 pay-period creation without Payroll execution, reconcile PR #215, and rerun combined Payroll route/API suites | Route/service permissions disagree, pay-period replay/overlap/audit test fails, Payroll/provider mutation occurs, QBO projection fails, or shared route behavior regresses |
...
test "$(git rev-parse origin/customer-management-v1)" = \
  858b59cdadbedd9bb6a248debea8b40e3a3941af
...
The branch is fourteen commits behind protected authority and has no open PR. PR #212 is
...
`858b59cd...` and its deployed binding only after Preview reports that exact SHA;
...
`d53e5d36422218bd715f07d8099e09865167e0f1`, has no PR, is 13 behind / 1 ahead,
and composes merge-clean at tree
`e86cb8b661081ec431900b941c6b1d538e60076c`. It has no schema change and is the
...
`ea688fdb08aec9261ca1c17ce611642d356ab27f`, run `git diff --check`, push the
...
Update the packet authority from `9096a777...` to `858b59cd...` and state that
...
`521be005d48e21dafcb02ca2ffa05098d30936d5`; lane qualification on 2026-09-12
...
Composition was revalidated on 2026-09-14 at tree
`980923c2dcdd312755d19b49762708671e11aeb4`; lane qualification on 2026-09-12
...
Composition was revalidated on 2026-09-14 at tree
`f4b43c0a049a821eddd6cc74c003a7b5b7e124fb`; lane qualification on 2026-09-12
...
`49e852aa8c931c8042de0634b68d993b0e02452e` is 21 behind / 13 ahead, has no PR,
and composes merge-clean at tree
`b29495a219786cbd8711c5767ec196f6d4d238c2`. It is stale and Git-reconcilable,
...
Composition was revalidated on 2026-09-14 at tree
`b29495a219786cbd8711c5767ec196f6d4d238c2`; PostgreSQL qualification on
...
| Pay-period office operations | Exact #277/#278 repair-successor candidate/merge/deployed SHA; policy-manager success and reporting-only denial; projection route/service role matrix; created/replayed period ID; contradictory-overlap rejection; single audit ID; before/after Payroll/provider state | Route/service permission mismatch, duplicate period/audit, cross-Company input or visibility, unauthorized success, changed-overlap acceptance, stale readiness, or any Payroll/provider execution |
...
- #257-#278, PR #215, and Mobile have no application-state rollback. Rebuild the previous
