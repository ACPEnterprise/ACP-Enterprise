...
| Estimates | Pricing, workflow, conversion and list API coverage (5 files) | Deterministic concurrent acceptance stress is not a dedicated suite |
...
| Inventory / Purchasing | Foundation, adjustments, reservations, cycle counts, purchasing policy, replenishment, three-way match and current-authority replay enforcement | Receipt/transfer/count concurrent-winner stress remains incomplete at current authority |
