...
| Database | Migration procedure | READY BUT UNPROVEN | One-shot migration gate exists; zero-to-head rehearsal passed all 174 revisions to one `n0p8q16g3t9u` head. Exact Production endpoint is absent. |
