...
SCENARIOS: Final[tuple[Scenario, ...]] = (
    ...
    Scenario("economics", "COMPANY_ADMINISTRATOR", "work, obligations and cash readiness remain distinct", ("tests/business_economics/test_owner_acceptance.py", "tests/business_economics/test_evidence_acceptance.py::test_workday_and_job_participation_are_distinct_reconcilable_contracts", "tests/business_economics/test_operational_source_expansion.py")),
