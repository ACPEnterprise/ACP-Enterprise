...
SCENARIOS: Final[tuple[Scenario, ...]] = (
    ...
    Scenario("lia", "OFFICE_MANAGER", "bounded read-only answers preserve evidence distinctions", ("tests/lia/test_governed_assistant.py", "tests/lia/test_cash_operational_adapter.py", "tests/lia/test_operational_intelligence_program_3.py")),
