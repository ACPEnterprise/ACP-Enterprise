...
SOURCE_REGISTRY = (
    ...
    SourceSpec(
        source_id="ESTIMATE_STATUS",
        authority="ESTIMATE_DOMAIN",
        required_permission=EstimatePermission.READ,
        sensitivity=Sensitivity.FINANCIAL,
        branch_scoped=True,
        max_results=1,
        freshness_contract="CURRENT_QUERY",
        provenance_contract="ESTIMATE_ID_VERSION",
        readiness=SourceReadiness.READY,
    ),
    SourceSpec(
        source_id="PAYMENT_STATUS",
        authority="PAYMENT_DOMAIN",
        required_permission=PaymentPermission.READ,
        sensitivity=Sensitivity.FINANCIAL,
        branch_scoped=True,
        max_results=1,
        freshness_contract="CURRENT_QUERY",
        provenance_contract="PAYMENT_RECEIPT_EVIDENCE_DIGEST",
        readiness=SourceReadiness.READY,
    ),
    SourceSpec(
        source_id="PURCHASING_STATUS",
        authority="PURCHASING_DOMAIN",
        required_permission=PurchasingPermission.READ,
        sensitivity=Sensitivity.FINANCIAL,
        branch_scoped=True,
        max_results=1,
        freshness_contract="CURRENT_QUERY",
        provenance_contract="PURCHASE_ORDER_ID_VERSION",
        readiness=SourceReadiness.READY,
    ),
    SourceSpec(
        source_id="INVENTORY_STATUS",
        authority="INVENTORY_DOMAIN",
        required_permission=InventoryPermission.READ,
        sensitivity=Sensitivity.INTERNAL_OPERATIONAL,
        branch_scoped=False,
        max_results=1,
        freshness_contract="CURRENT_QUERY",
        provenance_contract="INVENTORY_ITEM_ID_VERSION",
        readiness=SourceReadiness.READY,
    ),
    SourceSpec(
        source_id="LUMINARY_BRIEFING",
        authority="LUMINARY_BRIEFING.v1",
        required_permission=LuminaryPermission.READ,
        sensitivity=Sensitivity.FINANCIAL,
        branch_scoped=True,
        max_results=1,
        freshness_contract="PERSISTED_EVIDENCE",
        provenance_contract="LUMINARY_BRIEFING_DIGEST",
        readiness=SourceReadiness.READY,
    ),
    SourceSpec(
        source_id="MIGRATION_AUTHORITY",
        authority="HCP_MIGRATION_AUTHORITY",
        required_permission=AdministrationPermission.COMPANY_ADMINISTER,
        sensitivity=Sensitivity.SECURITY_ADMIN,
        branch_scoped=True,
        max_results=25,
        freshness_contract="PERSISTED_EVIDENCE",
        provenance_contract="MIGRATION_PACKAGE_DIGEST",
        readiness=SourceReadiness.READY,
    ),
    SourceSpec(
        source_id="PAYROLL_REPORTING",
        authority="PAYROLL_REPORTING_METADATA",
        required_permission=PayrollPermission.REPORTING_READ,
        sensitivity=Sensitivity.PAYROLL_PROTECTED,
        branch_scoped=False,
        max_results=100,
        freshness_contract="PERSISTED_EVIDENCE",
        provenance_contract="PAYROLL_REPORT_DIGEST",
        readiness=SourceReadiness.READY,
    ),
    SourceSpec(
