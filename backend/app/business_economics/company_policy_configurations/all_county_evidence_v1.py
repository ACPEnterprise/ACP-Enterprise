...
_SPECS = (
    ...
    (
        ...
        (
            ...
            "approval_id",
            "effective_period",
            "workday_time_reconciliation_id",
            "entry_provenance",
        ),
        ("acp_approved_job_participation",),
        (
    ...
    (
        ...
        ("acp_approved_job_participation",),
        ("dispatch_assignment_only", "workday_time_only"),
        False,
    ),
    (
        "direct_labor_measurement",
        ...
        (
            "participation_revision_id",
            "workday_revision_ids",
            "approval_id",
            "approved_by",
            "entry_provenance",
            "supersedes_revision_id",
    ...
    (
        ...
        ("acp_approved_job_participation",),
        ("appointment_assignment_only", "workday_time_only"),
        False,
    ),
    (
        "labor_burden",
