...
DOMAIN_REPLAY_EVIDENCE = {
    ...
    "customers": "tests/customer_migration/test_population_reconciliation.py",
    ...
    "service_agreements": "tests/service_agreements/test_service_agreements.py",
...
def test_every_mutating_operation_has_exactly_one_current_classification() -> None:
    ...
    assert len(operations) == len(coverage) == 349
