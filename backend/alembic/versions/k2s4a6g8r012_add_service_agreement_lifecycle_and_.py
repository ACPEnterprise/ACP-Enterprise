...
down_revision: str | Sequence[str] | None = "k1s3a5g7r901"
...
def upgrade() -> None:
    ...
    op.create_table(
        "service_agreement_billing_occurrences",
        ...
        sa.ForeignKeyConstraint(
            ["agreement_id"], ["service_agreements.id"], ondelete="RESTRICT"
        ),
    ...
    op.create_table(
        "service_agreement_lifecycle_evidence",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("company_id", sa.UUID(), nullable=False),
        sa.Column("branch_id", sa.UUID(), nullable=False),
        sa.Column("agreement_id", sa.UUID(), nullable=False),
