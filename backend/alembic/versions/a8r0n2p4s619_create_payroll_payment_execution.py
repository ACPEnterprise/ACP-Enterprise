...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("execution_idempotency_key", sa.String(96), nullable=False),
        sa.Column("execution_identity", sa.String(96), nullable=False),
        sa.Column("execution_digest", sa.String(64), nullable=False),
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("authorized_total", sa.Numeric(18, 2), nullable=False),
        sa.Column("lifecycle", sa.String(32), nullable=False),
        sa.Column(
            "authorized_by_user_id", postgresql.UUID(as_uuid=True), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("provider_safe_reference", sa.String(120)),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "uq_payroll_payment_execution_active_release",
        table_name="payroll_payment_executions",
    )
