"""create service agreement product authority

Revision ID: k1s3a5g7r901
...
revision = "k1s3a5g7r901"
down_revision = "g5e4c93b0f6d"
branch_labels = None
depends_on = None
...
def upgrade():
    op.create_table(
        ...
        sa.Column("billing_cadence", sa.String(20), nullable=False),
        sa.Column("duration_months", sa.Integer(), nullable=False),
        sa.Column("included_visits", sa.Integer(), nullable=False),
        sa.Column("benefits", sa.JSON(), nullable=False),
        sa.Column("renewal_policy", sa.JSON(), nullable=False),
        sa.Column("cancellation_policy", sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "plan_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("service_agreement_plans.id", ondelete="RESTRICT"),
            nullable=False,
        ),
        sa.Column("agreement_number", sa.String(40), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "agreement_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("service_agreements.id", ondelete="RESTRICT"),
            nullable=False,
        ),
        sa.Column(
            "service_location_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("service_locations.id", ondelete="RESTRICT"),
            nullable=False,
        ),
    ...
    op.create_table(
        "service_agreement_entitlements",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column(
            "company_id",
            postgresql.UUID(as_uuid=True),
        ...
        sa.Column("eligible_to", sa.Date(), nullable=False),
        sa.Column("status", sa.String(20), nullable=False),
...
def downgrade():
    op.drop_table("service_agreement_entitlements")
    op.drop_table("service_agreement_coverage")
    op.drop_table("service_agreements")
    op.drop_table("service_agreement_plans")
