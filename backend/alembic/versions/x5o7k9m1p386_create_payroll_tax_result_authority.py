...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint(
            "company_id", "id", name="uq_payroll_tax_result_company_id"
        ),
        sa.UniqueConstraint(
    ...
    op.create_index(
        "ix_payroll_tax_result_period",
        "payroll_tax_deduction_results",
        ["company_id", "pay_period_id", "employee_id"],
    )
    op.create_table(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_payroll_tax_result_period", table_name="payroll_tax_deduction_results"
    )
    op.drop_index(
        "uq_payroll_tax_result_active_subject",
        table_name="payroll_tax_deduction_results",
    )
