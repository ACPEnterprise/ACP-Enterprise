...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("destination_reference", sa.String(120), nullable=False),
        sa.Column("protected_envelope_id", postgresql.UUID(as_uuid=True)),
        sa.Column("masked_display", sa.String(80), nullable=False),
        sa.Column("verification_evidence_digest", sa.String(64), nullable=False),
        ...
        sa.Column("supersedes_destination_id", postgresql.UUID(as_uuid=True)),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["payroll_payment_destination_versions.id"],
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("payroll_run_digest", sa.String(64), nullable=False),
        sa.Column("pay_period_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("definition_version", sa.String(80), nullable=False),
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("package_identity", sa.String(96), nullable=False),
        sa.Column("package_digest", sa.String(64), nullable=False),
        sa.Column("aggregate_release_amount", sa.Numeric(18, 2), nullable=False),
        sa.Column(
            "assembled_by_user_id", postgresql.UUID(as_uuid=True), nullable=False
        ),
        sa.Column("assembled_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("lifecycle", sa.String(28), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["assembled_by_user_id"], ["users.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["supersedes_release_id"],
            ["payroll_payment_releases.id"],
            ondelete="RESTRICT",
        ),
        sa.UniqueConstraint(
    ...
    op.create_table(
        ...
        sa.Column("run_member_digest", sa.String(64), nullable=False),
        ...
        sa.Column("destination_digest", sa.String(64)),
        sa.Column("method_type", sa.String(32)),
        sa.Column("protected_destination_reference", sa.String(120)),
        sa.Column("amount", sa.Numeric(18, 2), nullable=False),
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("blocker_evidence_digest", sa.String(64)),
        sa.Column("instruction_identity", sa.String(96), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "uq_payroll_payment_release_active_run", table_name="payroll_payment_releases"
    )
    op.drop_table("payroll_payment_releases")
    op.drop_index(
        "ix_payroll_payment_destination_resolution",
        table_name="payroll_payment_destination_versions",
    )
