"""create day one payments runtime

Revision ID: x9n1j3l5p720
Revises: w8m0i2k4n619
"""
...
revision: str = "x9n1j3l5p720"
down_revision: str | Sequence[str] | None = "w8m0i2k4n619"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint(
            "amount > 0 AND currency ~ '^[A-Z]{3}$'", name="payment_intents_check"
        ),
        sa.CheckConstraint(
        ...
        sa.UniqueConstraint("company_id", "provider_idempotency_key"),
    ...
    op.create_table(
        ...
        sa.Column("intent_id", U, nullable=False),
        ...
        sa.UniqueConstraint("company_id", "intent_id", "sequence"),
    )
    op.create_table(
        "payment_receipts",
        sa.Column("id", U, primary_key=True),
        ...
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("status", sa.String(32), nullable=False),
        sa.Column("captured_amount", M, nullable=False),
        sa.Column("available_amount", M, nullable=False),
        sa.Column("applied_amount", M, nullable=False),
        sa.Column("refunded_amount", M, nullable=False),
        sa.Column("disputed_amount", M, nullable=False),
        sa.Column("evidence_digest", sa.String(64), nullable=False),
        sa.Column("version", sa.Integer, nullable=False),
        ...
        sa.UniqueConstraint("company_id", "intent_id"),
        sa.UniqueConstraint("company_id", "id"),
    )
    op.create_table(
        ...
        sa.Column("id", U, primary_key=True),
        sa.Column("company_id", U, nullable=False),
        sa.Column("receipt_id", U, nullable=False),
        sa.Column("event_type", sa.String(48), nullable=False),
        sa.Column("amount", M, nullable=False),
        sa.Column("invoice_id", U),
        sa.Column("external_identity", U),
        sa.Column("idempotency_key", sa.String(120), nullable=False),
        sa.Column("evidence_digest", sa.String(64), nullable=False),
        sa.Column("occurred_at", TZ, nullable=False),
        sa.ForeignKeyConstraint(
        ...
        sa.UniqueConstraint("company_id", "receipt_id", "idempotency_key"),
    )
    op.create_table(
        "payment_refunds",
        sa.Column("id", U, primary_key=True),
        ...
        sa.Column("approved_by_user_id", U),
        sa.Column("version", sa.Integer, nullable=False),
        sa.Column("created_at", TZ, nullable=False),
        sa.ForeignKeyConstraint(
            ["company_id", "receipt_id"],
        ...
        sa.CheckConstraint("amount > 0", name="payment_refunds_amount_check"),
        sa.UniqueConstraint("company_id", "idempotency_key"),
        sa.UniqueConstraint("company_id", "id"),
    )
    op.create_table(
        ...
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("status", sa.String(32), nullable=False),
        sa.Column("gross_amount", M, nullable=False),
        sa.Column("destination_reference", sa.String(120), nullable=False),
        sa.Column("idempotency_key", sa.String(120), nullable=False),
        sa.Column("evidence_digest", sa.String(64), nullable=False),
        sa.Column("prepared_by_user_id", U, nullable=False),
        sa.Column("approved_by_user_id", U),
        sa.Column("created_at", TZ, nullable=False),
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column("id", U, primary_key=True),
        sa.Column("company_id", U, nullable=False),
        sa.Column("deposit_id", U, nullable=False),
        sa.Column("receipt_id", U, nullable=False),
        sa.Column("amount", M, nullable=False),
        sa.ForeignKeyConstraint(
        ...
        sa.UniqueConstraint("company_id", "receipt_id"),
    )
    op.create_table(
        "payment_settlements",
        sa.Column("id", U, primary_key=True),
        ...
        sa.Column("provider", sa.String(64), nullable=False),
        sa.Column("merchant_account", sa.String(120), nullable=False),
        sa.Column("provider_payout_id", sa.String(255), nullable=False),
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("settlement_date", sa.Date, nullable=False),
        sa.Column("gross_amount", M, nullable=False),
        sa.Column("refund_amount", M, nullable=False),
        sa.Column("dispute_amount", M, nullable=False),
        sa.Column("fee_amount", M, nullable=False),
        sa.Column("adjustment_amount", M, nullable=False),
        sa.Column("net_amount", M, nullable=False),
        sa.Column("status", sa.String(32), nullable=False),
        sa.Column("evidence_digest", sa.String(64), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("entity_id", U, nullable=False),
        sa.Column("reason_code", sa.String(80), nullable=False),
        sa.Column("status", sa.String(16), nullable=False),
        sa.Column("idempotency_key", sa.String(120), nullable=False),
        sa.Column("evidence_digest", sa.String(64), nullable=False),
        sa.Column("opened_by_user_id", U),
    ...
    op.create_table(
        ...
        sa.Column("allowed_evidence", postgresql.JSONB, nullable=False),
        sa.Column("received_at", TZ, nullable=False),
        sa.UniqueConstraint(
            "company_id", "provider", "merchant_account", "provider_event_id"
        ),
        sa.UniqueConstraint("company_id", "evidence_digest"),
    )
    op.create_table(
        ...
        sa.Column("source_event_id", U, nullable=False),
        sa.Column("journal_id", U, nullable=False),
        sa.Column("journal_version", sa.Integer, nullable=False),
        sa.Column("policy_version", sa.String(80), nullable=False),
        sa.Column("status", sa.String(32), nullable=False),
        sa.Column("effective_date", sa.Date, nullable=False),
        sa.Column("posted_at", TZ, nullable=False),
        sa.UniqueConstraint("company_id", "source_event_id"),
    )
...
def downgrade() -> None:
    for table in (
        ...
        op.drop_table(table)
    op.drop_index("ix_payment_intents_scope", table_name="payment_intents")
