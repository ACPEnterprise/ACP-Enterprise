export type Capability = "home.view" | "time.self.view" | "time.self.punch" | "my_day.view" | "jobs.view" | "jobs.execute" | "pay.self.view" | "assets.view" | "estimates.view" | "price_book.view" | "customers.view" | "invoices.view" | "payments.view" | "communications.view" | "notifications.view" | "team_time.view";
...
export function capabilitiesFromPermissions(permissionCodes: readonly string[]): Capability[] {
  ...
  if (permissionCodes.includes("COMPANY_CUSTOMER_READ")) capabilities.push("customers.view");
