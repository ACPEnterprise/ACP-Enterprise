...
export async function createOptionGroup(data: { code: string; name: string }): Promise<PriceBookOptionGroup> { return (await apiClient.post<PriceBookOptionGroup>(`${path}/option-groups`, data)).data; }
