...
export function DispatchScopeControls({ date, branchId, branches, timeZone, onDateChange, onBranchChange }: { readonly date: string; readonly branchId: string; readonly branches: readonly AccessibleBranch[]; readonly timeZone: string; readonly onDateChange: (value: string) => void; readonly onBranchChange: (value: string) => void }) {
