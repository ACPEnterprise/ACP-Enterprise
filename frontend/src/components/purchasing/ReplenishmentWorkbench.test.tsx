...
const result: Result = {
  ...
  recommendations: [{
    ...
    provenance: ["inventory:item-1"],
    evidence_digest: "recommendation-digest",
  }],
};
...
describe("ReplenishmentWorkbench disposition authority", () => {
  it("keeps recommendation evidence visible but hides mutation controls from read-only users", () => {
  ...
  it("shows disposition controls to an approval-authorized user and prevents duplicate actions while pending", () => {
