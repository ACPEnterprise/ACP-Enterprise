...
describe("CustomerOperationsPanel office workflow", () => {
  beforeEach(() => {
    ...
    vi.mocked(paymentHooks.usePayments).mockReturnValue(query([{ id: "receipt-1", customer_id: "customer-1", currency: "USD", status: "partially_applied", captured_amount: "35.00", applied_amount: "25.00", available_amount: "10.00", captured_at: "2026-09-12T00:00:00Z" }]) as never);
  });
  ...
  it("separates current and historical work and preserves action context", () => {
    ...
    expect(screen.getByRole("link", { name: /USD 35.00/ })).toHaveAttribute("href", "/payments/receipt-1");
