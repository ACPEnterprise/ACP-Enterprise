...
export function IdentityOnboardingRoute() {
  ...
  return <div className="mx-auto w-full max-w-2xl space-y-ui-5 pb-ui-8">
    ...
    <div className="flex gap-ui-4"><Link className="text-link" to="/workforce">View Team</Link><Link className="text-link" to="/administration">Advanced Administration</Link></div>
  </div>;
}
