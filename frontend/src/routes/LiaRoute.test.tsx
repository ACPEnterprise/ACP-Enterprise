...
vi.mock("../hooks/useLia", () => ({
  useLiaReadiness: () => ({ isPending: false, isError: state.readinessError, refetch: state.readinessRefetch, data: state.readinessError ? undefined : {
  ...
  useOwnerBriefing: () => ({ isPending: false, isError: state.briefingError, refetch: state.briefingRefetch, data: state.briefingError ? undefined : {
