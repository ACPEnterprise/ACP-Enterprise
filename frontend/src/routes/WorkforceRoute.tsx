...
export function WorkforceRoute() {
  ...
  const [correctionKind, setCorrectionKind] = useState<"missing_clock_out" | "missing_interval" | "overlapping_intervals" | "incorrect_start" | "incorrect_stop">("missing_clock_out");
