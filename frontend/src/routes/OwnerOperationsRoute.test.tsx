...
describe("OwnerOperationsRoute", () => {
  beforeEach(() => {
    ...
    vi.spyOn(api, "getIntegrationReadiness").mockResolvedValue({ qbo: "not_connected", migration: { overall_status: "BLOCKED", current_phase: "qualification", authority_digest: "safe", reconciliation_digest: "safe", stale: false, safe_failure_code: null, go_no_go: { state: "blocked", activation_eligible: false, blockers: ["source_acceptance"] }, historical_window: { starts_on: null, ends_on: "2026-08-30", opening_evidence_state: "UNKNOWN", completeness: "UNKNOWN" }, sources: [], counts: [], timeline: [], authority_states: [], owner_decisions: [{ decision: "source_acceptance", state: "OWNER_DECISION" }], decision_packets: [], freeze_authority: { state: "external_authorization_required", required_authority: "owner", sources: [], evidence: "immutable_manifest", late_change_behavior: "invalidate_delta_and_return_to_reconciliation", reopen_behavior: "new_freeze_generation_required" }, run_history: [], recovery_state: "BLOCKED" } });
