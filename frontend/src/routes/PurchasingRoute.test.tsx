...
describe("PurchasingRoute", () => {
  ...
  it("keeps recommendations read-only without approval authority", () => {
    replenishmentMutation.data = { schema_version: 1, company_id: "company-1", as_of: "2026-08-29T12:00:00Z", evidence_digest: "report", recommendations: [{ branch_id: "branch-1", inventory_item_id: "item-1", item_code: "FILTER", item_name: "Filter", stocking_unit: "each", target_available_quantity: "10", on_hand_quantity: "2", reserved_quantity: "0", available_quantity: "2", open_purchase_order_quantity: "3", recommended_order_quantity: "5", recommendation_state: "recommend_order", provenance: [], evidence_digest: "recommendation" }] } as never;
  ...
  it("surfaces stale failure and removes stale actionable state", async () => {
