...
export const financialsHandle = {
  workspace: { pageTitle: "Financial History", breadcrumbs: [{ label: "Financial History" }], helpTopic: "financial-history", aiContext: "financials" },
} as const satisfies ShellRouteHandle;
