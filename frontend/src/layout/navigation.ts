...
export const navigationCatalog = [
  ...
  { id: "estimates", label: "Estimates", path: "/estimates", icon: FileChartColumn, availability: "available" },
  ...
  { id: "invoices", label: "Invoices", path: "/invoices", icon: FileText, availability: "available" },
